                ...
                <Flex direction="column" gap={4} className="costered-blocks--display-controls--inner">
                    <FlexItem>
                        <SelectControl
                            ...
                            onChange={setDisplay}
                        >
                            <SelectControl.Option value=""><DefaultIcon />{LABELS.displayControls.unset}</SelectControl.Option>
                            <SelectControl.Option value="block"><BrickOulineRounded />{LABELS.displayControls.displayBlock}</SelectControl.Option>
                            <SelectControl.Option value="inline"><MatchWordRounded />{LABELS.displayControls.displayInline}</SelectControl.Option>
                            <SelectControl.Option value="flex"><FlexNoWrapRounded />{LABELS.displayControls.displayFlex}</SelectControl.Option>
                            <SelectControl.Option value="grid"><GridViewRounded />{LABELS.displayControls.displayGrid}</SelectControl.Option>
                            <SelectControl.Option value="none"><BorderNoneVariant />{LABELS.displayControls.displayNone}</SelectControl.Option>
                        </SelectControl>
                    </FlexItem>
                    <FlexItem>
                        <SelectControl
                        ...
                        >
                            <SelectControl.Option value=""><DefaultIcon />{LABELS.displayControls.visibilityUnset}</SelectControl.Option>
                            <SelectControl.Option value="visible"><EyeOutline />{LABELS.displayControls.visibilityVisible}</SelectControl.Option>
                            <SelectControl.Option value="hidden"><EyeOffOutline />{LABELS.displayControls.visibilityHidden}</SelectControl.Option>
                            <SelectControl.Option value="collapse"><Collapse />{LABELS.displayControls.visibilityCollapse}</SelectControl.Option>
                        </SelectControl>
                    </FlexItem>
                </Flex>
            </PanelBody>
