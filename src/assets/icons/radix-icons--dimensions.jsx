const RadixIconsDimensions = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" width={size} height={size} {...props}>
...
export default RadixIconsDimensions;
